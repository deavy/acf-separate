...
class acf_field_separation extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->l10n = array(
			//'error'	=> __('Error! Please enter a higher value', 'acf-separation'),
		);
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		wp_register_style( 'acf-input-separation', "{$dir}css/input.css" ); 
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-separation'),
		}
