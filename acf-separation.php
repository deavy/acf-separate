<?php
/*
Plugin Name: Advanced Custom Fields: Separation0
Plugin URI: https://github.com/yaybrigade/acf-separate
GitHub Plugin URI: https://github.com/yaybrigade/acf-separate
Description: Extends ACF (Advanced Custom Fields) plugin and adds a separator field for better visual clarity.
Version: 1.0.3
Author: Roman Jaster, Yay Brigade, Deavy
